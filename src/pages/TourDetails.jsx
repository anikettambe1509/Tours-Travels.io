              ...
              <div className="tour__content">
                ...
                <div className="tour__reviews mt-4">
                  ...
                  <Form onSubmit={submitHandler}>
                    <div className='d-flex align-items-center gap-3 mb-4 rating__group'> <h6>Give rating by this stars:</h6>
                      ...
                      <div className="review__item">
                        ...
                        <div className="w-100">
                          <div className='d-flex align-items-center justify-content-between'>
                            <div>
                              <h5>aniket</h5>
                              <p>{new Date("07-15-2024").toLocaleDateString("en-US", options)}</p>
                            </div>
